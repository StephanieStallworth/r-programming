...
# Encoding step optional for most models like Logistic Regression, KNN, Naïve Bayes, SVM and Kernel SVM as the package used to build those models will recognize classes of dataset as classes
